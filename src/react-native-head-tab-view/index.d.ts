...
type HScrollViewType = React.ForwardRefExoticComponent<
  React.PropsWithoutRef<React.PropsWithChildren<ScrollViewProps>> &
    React.RefAttributes<ScrollView> &
    NormalSceneBaseProps
>;
type HFlatListType<T = any> = React.ForwardRefExoticComponent<
  React.PropsWithoutRef<FlatListProps<T>> &
    React.RefAttributes<FlatList<T>> &
    NormalSceneBaseProps
>;
type HSectionListType<T = any> = React.ForwardRefExoticComponent<
  React.PropsWithoutRef<SectionListProps<T>> &
    React.RefAttributes<SectionList<T>> &
    NormalSceneBaseProps
>;
...
export const GestureContainer: React.ForwardRefExoticComponent<
  React.PropsWithoutRef<IGestureContainerProps> &
